...
/**
 * Classe pour gérer l'exécution de requêtes via le proxy API
 */
class ApiQueryProvider implements IQueryProvider {
  /**
...
/**
 * Instance exportée du provider de requêtes API
 */
export const apiQueryProvider = new ApiQueryProvider();